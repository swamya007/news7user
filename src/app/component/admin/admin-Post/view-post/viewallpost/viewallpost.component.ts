...
export class ViewallpostComponent implements OnInit {
  ...
  clearAll() {
    ...
    let obj:any = {}
    obj.page_no = this.p; obj. customer_id = this.currentuser.customer_id;
    obj.post_val = this.searchval; obj.category_id = this.categorysearch;
    obj.year = this.yearSearch; obj.month = this.monthSearch; 
    obj.author = this.authorsearch; obj.date_val = this.dateSearch;

    this.post.postPagination(obj).subscribe((res: any) => {
  ...
  gty(page: any) {
    ...
    let obj:any = {}
    obj.page_no = page; obj. customer_id = this.currentuser.customer_id;
    obj.post_val = this.searchval; obj.category_id = this.categorysearch;
    obj.year = this.yearSearch; obj.month = this.monthSearch; 
    obj.author = this.authorsearch; obj.date_val = this.dateSearch;
