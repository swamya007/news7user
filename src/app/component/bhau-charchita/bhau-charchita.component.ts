...
@Component({
  selector: 'app-bhau-charchita',
  templateUrl: './bhau-charchita.component.html',
  styleUrls: ['./bhau-charchita.component.css'],
})
export class BhauCharchitaComponent implements OnInit {
  customer_id: any;
  ads_id: any;
  img_size: any;
  page = 1;
