...
display:boolean=false
  constructor(private notify:NotificationService,private userservic:UserService) { }
  ...
  sendotp(){
    ...
    this.userservic.forgetpassword({key:this.verify_user.username}).subscribe((res)=>{
      console.log(res);
      if(res.code=='success'){
